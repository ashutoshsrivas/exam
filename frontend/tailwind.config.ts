  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        info: { DEFAULT: 'hsl(var(--info))', foreground: '#fff' },
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      boxShadow: {
        soft: '0 1px 2px hsl(220 25% 20% / 0.04), 0 4px 12px hsl(220 25% 20% / 0.04)',
        lift: '0 4px 6px hsl(220 25% 20% / 0.05), 0 12px 32px hsl(220 25% 20% / 0.08)',
